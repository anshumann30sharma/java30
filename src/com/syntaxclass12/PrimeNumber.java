...
public class PrimeNumber {
	...
	public static void main(String[] args) {
		/* We need to divide an input number, 
		 * say 17 from values 2 to 17 and check the remainder.
		...
		If a numberToCheck is completely divisible by other number,
		 flag isPrime is set to true and the loop is exited.
